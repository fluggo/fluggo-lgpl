...
namespace Fluggo.CodeGeneration.IL {
	/// <summary>
	/// Represents an expression for a constant 16-bit unsigned integer.
	/// </summary>
	[CLSCompliant(false)]
	public sealed class UInt16ConstantExpression : Expression {
		ushort _value;

		/// <summary>
		/// Creates a new instance of the <see cref="UInt16ConstantExpression"/> class.
		/// </summary>
		/// <param name="value">Value of the integer.</param>
		public UInt16ConstantExpression( ushort value ) {
			_value = value;
		}
		...
		///   This property always returns <see cref="UInt16"/>.</value>
		...
		public override string ToString() {
			return "(ushort) " + _value.ToString( CultureInfo.InvariantCulture );
		}
			...
			switch( _value ) {
				...
				default:
					if( _value <= 127 ) {
						...
						cxt.Generator.Emit( OpCodes.Ldc_I4, unchecked((int) _value) );
					}
