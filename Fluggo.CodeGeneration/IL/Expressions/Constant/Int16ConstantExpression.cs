...
namespace Fluggo.CodeGeneration.IL {
	/// <summary>
	/// Represents an expression for a constant 16-bit signed integer.
	/// </summary>
	public sealed class Int16ConstantExpression : Expression {
		short _value;

		/// <summary>
		/// Creates a new instance of the <see cref="Int16ConstantExpression"/> class.
		/// </summary>
		...
		///   This property always returns <see cref="Int16"/>.</value>
		...
		public override string ToString() {
			return "(short) " + _value.ToString( CultureInfo.InvariantCulture );
		}
