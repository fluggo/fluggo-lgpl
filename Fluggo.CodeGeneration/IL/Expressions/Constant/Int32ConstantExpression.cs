...
namespace Fluggo.CodeGeneration.IL {
	/// <summary>
	/// Represents an expression for a constant 32-bit signed integer.
	/// </summary>
	public sealed class Int32ConstantExpression : Expression {
		int _value;

		/// <summary>
		/// Creates a new instance of the <see cref="Int32ConstantExpression"/> class.
		/// </summary>
		...
		///   This property always returns <see cref="Int32"/>.</value>
			...
			switch( _value ) {
				...
				default:
					if( _value >= -128 && _value <= 127 ) {
						...
						cxt.Generator.Emit( OpCodes.Ldc_I4, _value );
					}
