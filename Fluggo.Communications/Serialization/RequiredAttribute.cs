...
{
	/// <summary>
	/// Indicates that the decorated field cannot be null.
	/// </summary>
	[AttributeUsage( AttributeTargets.Parameter | AttributeTargets.ReturnValue | AttributeTargets.Field, AllowMultiple = true )]
	public sealed class RequiredAttribute : SerializationAttribute
	{
		/// <summary>
		/// Creates a new instance of the <see cref='RequiredAttribute'/> class.
		/// </summary>
