...
namespace Fluggo.Graphics.MeshGenerators {
	...
	public static class CubeMesh {
		...
		public static Mesh CreateCubeMesh( float size, float textureRepeat ) {
			Mesh mesh = CreateSimpleSkyBox( size, textureRepeat );
			...
			return new Mesh( mesh.VertexDeclaration, mesh.VertexBuffer, indices );
		}
	}
}